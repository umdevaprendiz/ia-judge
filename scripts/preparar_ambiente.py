"""Cria o .env local (fora do git) com senhas aleatórias para o MySQL de desenvolvimento.

    python scripts/preparar_ambiente.py

Roda uma vez por máquina (e no CI). Se o .env já existir, só acrescenta o que faltar;
nunca troca uma senha já gerada. Nenhuma senha fica no repositório.
"""
...
def main() -> None:
    ...
    novos = {
        ...
        "DATABASE_URL": atuais.get("DATABASE_URL") or f"mysql+pymysql://sergius:{senha_app}@127.0.0.1:33307/sergius",
    }
