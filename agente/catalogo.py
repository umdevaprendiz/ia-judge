...
INDICIOS_DE_CRIMES: tuple[tuple[str, float, re.Pattern], ...] = tuple(
    ...
    for rotulo, peso, padrao in (
        ...
        ("CP.art147", 24, r"amea[çc]\w*[^.;]{0,40}(?:de morte|mat[áa]-l|de mal)|amea[çc]ou"),
        ...
        ("CP.art159", 40, r"sequestr\w+[^.;]{0,120}resgate|pediu (?:um )?resgate"),
        ...
        ("CP.art148", 30, r"c[áa]rcere privado|privou[^.;]{0,60}liberdade|mant\w+[^.;]{0,20}trancad"),
